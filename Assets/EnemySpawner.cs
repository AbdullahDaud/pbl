...
public class EnemySpawner : MonoBehaviour
{
    ...
    private void SpawnEnemy(float speed)
    {
        ...
        // Ambil skrip EnemyHealth dan atur healthBar
        EnemyHealth enemyHealth = enemy.GetComponent<EnemyHealth>();
        if (enemyHealth != null)
        {
            // Jika Anda memiliki lebih dari satu prefab musuh, pastikan slider bar HP di prefab tersebut terhubung
            enemyHealth.healthBar = enemy.GetComponentInChildren<Slider>(); // Ambil slider dari anak prefab
        }
    }
